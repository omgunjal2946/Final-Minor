...
export default function StudentDashboard() {
  ...
  const handleJoin = () => {
    ...
    alert(`Joining quiz with code: ${joinCode}`);
    // later we will connect socket here
  };
    ...
    <div className="min-h-screen bg-dark-950 px-6 py-10">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <StatCard icon={<Trophy />} label="Quizzes Passed" value={quizzes.length} color="text-purple-400" />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 glass p-6 rounded-2xl">
            <h2 className="text-2xl font-bold mb-6 flex items-center">
              <Activity className="w-6 h-6 mr-2 text-primary-400" /> Recent Quizzes
            </h2>
          ...
          <div className="glass p-6 rounded-2xl flex flex-col items-center justify-center text-center">
            ...
            <input
              ...
              placeholder="000-000"
              className="w-full bg-dark-800 border border-gray-700 text-center tracking-widest text-xl py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 mb-4"
            />

            <button
              onClick={handleJoin}
              className="w-full bg-white text-dark-900 font-bold py-3 rounded-lg hover:bg-gray-200 transition-colors"
            >
              Join Server
            </button>
          </div>
